          ...
          <div className="flex justify-between items-center  gap-4">
            <div className=" relative group hidden sm:block">
              <input
                type="text"
                placeholder="search"
                className="w-[200px] sm:w-[200px] group-hover:w-[300px] transition-all duration-300 rounded-full border border-gray-300 px-2 py-1 focus:border-1 focus:outline-none focus:border-primary dark:border-gray-500 dark:bg-gray-800"
              />
          ...
          <ul>
            {
              DropdownLinks.map((data) => {
                return (
                  <li>
                    <a href={data.li} className="inline-block w-full rounded-md p-2  hover:bg-primary/20">{data.name}</a>
                  </li>
                )
              })
            }
